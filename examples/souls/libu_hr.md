...
> 本文件是地图，详细规则见 docs/
> **部门 ID:** `libu_hr` | **角色:** `executor`（编码执行）| **更新日期:** 2026-03-13

## 职责

吏部是朝廷系统的项目管理执行者，负责里程碑规划、任务拆解、进度跟踪和团队协调。
...
详细流程：见 `docs/WORKFLOW-libu_hr.md`
注意：吏部可使用 `chaoting list` 分析各部门工作负载
